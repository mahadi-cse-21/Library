...
<body class="antialiased bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-50 animated-bg min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
    <div class="w-full max-w-4xl fade-in">
        ...
        <div class="gradient-border">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-2xl">
                ...
                <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 animated-bg px-6 sm:px-10 py-10 relative overflow-hidden">
                    <!-- Abstract decorative shapes -->
                    <div class="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 rounded-full bg-white opacity-10"></div>
                    <div class="absolute bottom-0 left-0 -mb-10 -ml-10 w-32 h-32 rounded-full bg-white opacity-10"></div>
                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label for="img" class="block text-sm font-medium text-gray-700 mb-3">Profile Image</label>
                                        <div class="flex flex-col items-center">
                                            <div class="mb-3 overflow-hidden rounded-full h-32 w-32 bg-gray-100 border-4 border-white shadow-lg" id="image-preview">
                                                <img id="preview-img" src="#" alt="Profile preview" class="h-full w-full object-cover object-center hidden">
                                                <div id="default-preview" class="h-full w-full flex items-center justify-center">
                                                    <svg class="h-16 w-16 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                                    </svg>
                                                </div>
                                            </div>
                                            <label class="image-upload-label cursor-pointer mt-2 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150">
                                                <svg class="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 01-.707-.293l-1.121-1.121A2 2 0 0011.172 3H8.828a2 2 0 00-1.414.586L6.293 4.707A1 1 0 015.586 5H4zm6 9a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd" />
                                                </svg>
                                                Upload Photo
                                                <input type="file" name="img" id="img" class="sr-only" accept="image/*" required>
                                            </label>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div id="student_fields" class="space-y-5 hidden">
                                            ...
                                            <div>
                                                ...
                                                <div class="relative rounded-md shadow-sm">
                                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                        <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fill-rule="evenodd" d="M18 8a6 6 0 01-7.743 5.743L10 14l-1 1-1 1H6v-1l1-1 1-1-0.257-0.257A6 6 0 1118 8zm-6-4a1 1 0 100 2 2 2 0 012 2 1 1 0 102 0 4 4 0 00-4-4z" clip-rule="evenodd" />
                                                        </svg>
                                                    </div>
                                        ...
                                        <div id="librarian_fields" class="space-y-5 hidden">
                                            <h3 class="text-lg font-semibold text-gray-800 mb-3">Librarian Information</h3>
                                    ...
                                    <div class="mt-8">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500">Must be at least 8 characters with mixed case and numbers</p>
                                            @error('password')
                                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        </div>
                        ...
                        <div class="pt-6 border-t border-gray-200">
                            <div class="flex flex-col-reverse sm:flex-row items-center justify-between">
                                <a href="{{ route('login') }}" class="mt-3 sm:mt-0 text-sm font-medium text-indigo-600 hover:text-indigo-500 flex items-center">
