                    ...
                    <div class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 w-full md:w-auto">
                        <a href="{{ route('addnewstudent') }}"
                            ...
                            <a href="{{ route('students.export') }}"
                                class="px-4 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-300 inline-flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <select id="department" name="department"
                                    ...
                                    <option value="Computer Science and Engineering" {{ request('department') == 'Computer Science and Engineering' ? 'selected' : '' }}>Computer Science and Engineering</option>
                                    <option value="Mathematics" {{ request('department') == 'Mathematics' ? 'selected' : '' }}>Mathematics
                                    </option>
                                    <option value="English" {{ request('department') == 'English' ? 'selected' : '' }}>English
                                    </option>
                                    <option value="Accounting" {{ request('department') == 'Accounting' ? 'selected' : '' }}>Accounting
                                    </option>
                            ...
                            <div>
                                ...
                                <select id="status" name="status"
                                    ...
                                    <option value="inactive" {{ request('status') == 'inactive' ? 'selected' : '' }}>
                                        Inactive</option>
                                    <option value="suspend" {{ request('status') == 'suspended' ? 'selected' : '' }}>
                                        Suspended</option>
